...
const Home = () => {
  return (
    <div className='bg-gray-100 min-h-screen'>
      {/* Hero Section */}
      <section className='bg-blue-800 text-white py-2 z-[-1]'>
        <div className='container mx-auto text-center'>
          <h1 className='text-4xl font-bold mb-4'>Find Your Perfect Stay</h1>
          <p className='text-xl mb-8'>Search for hotels, resorts, and more!</p>
          ...
          <div className='flex max-w-md mx-auto'>
            ...
            <button 
              type="submit" 
              className='bg-blue-600 text-white px-4 py-2 rounded-r-lg font-bold hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600'>
              Search
            </button>
          </div>
        </div>
      ...
      <section className='bg-blue-800 text-white py-16'>
        <div className='container mx-auto text-center'>
          ...
          <p className='text-xl mb-8'>Explore our wide range of options and book your perfect hotel now!</p>
          <a href="/homescreen" className='inline-block bg-blue-600 text-white py-2 px-6 rounded-lg font-bold hover:bg-blue-700'>
            Book Now
          </a>
        </div>
      </section>
