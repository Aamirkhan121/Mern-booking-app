...
<div className="row">
  ...
  <h2 className="text-xl font-semibold mb-2">Type: {room.name}</h2>
  ...
  {/* Align the View button to the right */}
  <div className="flex justify-end">
    <Link to={`/book/${room._id}`}>
    <button className="bg-blue-500 text-white mr-5 px-4 py-2 rounded-lg hover:bg-blue-600">Book Now</button>
    </Link>
    <button
